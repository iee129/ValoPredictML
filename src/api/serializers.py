...
docs/08_web/02_backend_fastapi/04_schemas.md, 06_insights/03·04 기준.
"""
from __future__ import annotations

from typing import Any

from inference.predict import ROLE_LABELS, feature_label  # 기존 라벨 매핑 재사용

ROLES = ("duelist", "initiator", "controller", "sentinel")
# {"타격대":"duelist", ...} — inference.predict.ROLE_LABELS(영문→한국어)의 역매핑
...
def serialize_prediction(r: Any) -> dict:
    ...
    return {
        "map": r.map_name,
        "cutoff_year": getattr(r, "cutoff_year", None),
