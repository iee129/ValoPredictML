# 10_valorant — Valorant 게임 도메인 리서치
...
| [sources.md](sources.md) | 인용 URL 34개 (Riot 공식 + Liquipedia + VLR.gg + 프로팀) | — |
...
hypotheses = load_domain_hypotheses("docs/10_valorant/")
...
- **sources.md**: URL 변경 시 즉시 (linkrot 방지)
