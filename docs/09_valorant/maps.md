...
`src/domain/agent_roles.py`의 `MAP_ORDER` 기준 **13개 맵** (Corrode 정규 포함). 활성 경쟁 풀(active competitive pool)은 시즌마다 7-9개로 로테이션됨.
...
- `src/domain/agent_roles.py`의 `MAP_ORDER`에 "Corrode"로 등록됨 (index 12). `normalize_map("Corrode")` 정상 동작.
...
VCT 토너먼트·시즌·지역별 어택측 승률 — **시즌·지역별 큰 변동** (메타 + 맵 리워크 영향).

⚠️ **VCT 2026 시즌 큰 메타 변동 발견** (Liquipedia 직접 검증 2026-05-09):
- **Bind**: 2025 Champions 어택 45.9% → **VCT 2026 Masters Santiago 어택 67.0%** (수비→어택 강세 급변)
- **Ascent**: **VCT 2026 EMEA Stage 1 어택 61.0%** (역대 최고 어택 강세)
- **Pearl**: VCT 2026 지역별 분산 (EMEA 43%, Americas 54.8%, Pacific 49.2%)
- **Skye/Chamber 메타 in 회복**: 2025 Champions 메타 outside → VCT 2026 Masters Santiago top picks
- **VCT 2026 4 stages 데이터 확보**: VCT 2026 Masters Santiago + VCT 2026 EMEA/Americas/Pacific Stage 1


**전체 시즌 사이드 어드밴티지 (어택측 승률 %)**:

| 맵 | 22 Champ | 24 Pac KO | 24 Champ | 25 EMEA S1 | 25 Amer S1 | 25 Pac S1 | 25 Champ | 26 Mast Sant | 26 EMEA S1 | 26 Amer S1 | 26 Pac S1 | 카테고리 |
|----|----------|-----------|----------|-----------|-----------|-----------|----------|-------------|-----------|-----------|-----------|----------|
| Ascent | 45.8 | 57.1 | 46.0 | 45.8 | 44.8 | 45.9 | 50.2 | — | **61.0** | — | — | Mid-control (큰 분산) |
| Bind | 52.0 | 49.4 | 53.6 | — | — | — | **45.9** | **67.0** | 52.2 | 57.1 | 58.1 | Closed (**26 어택 급변**) |
| Haven | 48.1 | — | 47.5 | 56.9 | 52.9 | 56.3 | **57.7** | 56.9 | 56.2 | 46.3 | 53.1 | Multi-site (어택 강세 일관) |
| Split | — | 50.0 | — | 45.8 | 48.6 | 49.2 | 비활성 | 49.4 | 43.7 | 48.1 | 44.2 | Closed/Vertical |
| Icebox | 53.5 | 57.9 | 51.3 | 52.7 | 54.8 | 52.9 | 비활성 | — | — | — | — | Open (어택 강세 일관) |
| Breeze | 47.7 | 48.1 | — | — | — | — | 비활성 | 48.5 | 57.1 | 58.8 | 45.0 | Open (지역 분산 큼) |
| Fracture | 49.0 | — | — | 49.3 | 50.3 | 51.0 | — | — | 55.2 | 63.2 | 61.2 | Dual-spawn (어택 강세) |
| Pearl | 46.8 | — | — | 49.3 | 53.6 | 42.5 | — | 48.5 | 43.0 | 54.8 | 49.2 | Closed (지역 분산 큼) |
| Lotus | — | 56.2 | 54.4 | 52.4 | 51.6 | 49.5 | 51.0 | — | 53.9 | 49.7 | 51.5 | Multi-site (어택 약 유리) |
| Sunset | — | 41.0 | 53.6 | — | — | — | 39.6 | — | — | — | — | (12.00에서 비활성) |
| Abyss | — | — | 50.6 | — | — | — | 57.9 | 49.7 | — | — | — | Vertical |
| Corrode | — | — | — | — | — | — | 51.4 | 55.6 | — | — | — | (신규 2025) |
