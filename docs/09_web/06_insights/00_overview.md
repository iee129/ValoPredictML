...
| (오프라인) 사전 집계 빌더 | N·K 공통 | [05_precompute_and_data.md](05_precompute_and_data.md) | `ml/insights/` 신규 잡 | `reports/insights/*.json` |
...
- 유일 소스는 `ml/vlrgg/client.py`의 `/stats?timespan=30/60/90`인데 (a) 외부 자체호스팅 API, (b) 모델 제외된 "수집 중" 소스, (c) VLR ID ↔ Kaggle 선수명 매칭 문제.
