# 01. 현재 피처 엔지니어링 (초기 설계 스펙 43개 — 실제 구현: baseline 421개 / advanced 179개)
...
**총 43개 피처 + 1개 레이블 (초기 설계 스펙 — 실제 구현: baseline 421피처 / advanced 179피처)**

> 참고: 실제 파이프라인 피처 수는 `reports/baseline/metrics.json`(421) 및 `reports/advanced/metrics.json`(179) 참조.
