...
> 목표였던 80K 이상은 달성했으며, 현재 advanced 학습·평가 단위는 91,458개 맵 단위 승패 샘플이다.
...
| **Phase 3 (목표)** | **100,000+ 경기** | **+ 피처 확장** | **80-84% (미달성 추정 — 현재 advanced Acc 0.6454; Kaggle 단독 데이터 한계 존재)** |

---

## 2. 소스별 수집 목표

> ⚠️ **본 문서는 방침 변경 전 초기 계획** — 현재 active 계약은 Kaggle+VLR.gg 통합이며, 본문의 목표치는 과거 계획 참고용이다.
